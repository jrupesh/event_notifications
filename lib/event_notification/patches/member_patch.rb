  ...
  module Patches
    module MemberPatch
      ...
      def self.included(base) # :nodoc:
        base.const_set('AVAILABLE_EVENTS',EventNotification::Patches::MemberPatch::EventsConstant::AVAILABLE_EVENTS)
...
unless Member.included_modules.include? EventNotification::Patches::MemberPatch
